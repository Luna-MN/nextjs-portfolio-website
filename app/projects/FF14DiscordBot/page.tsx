        ...
        <div className="relative pb-16">
            ...
            <div className="min-h-screen mx-auto lg:mx-0 pt-20 ">
                ...
                <h2 className="flex justify-center items-center mt-4 text-zinc-100">
                    A discord bot for FFXIV I worked on with a friend
                </h2>
                <p className="flex justify-center items-center mt-4 text-zinc-400">
                    ...
                    does this but using the XIVDB api and searching for the item
                    this will give you a long list of accosiated ID's and from
                    this <br /> we can sanitize the data into places you get the
